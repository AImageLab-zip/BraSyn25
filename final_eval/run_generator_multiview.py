...
model_axi= HFGAN_3D(view='axi',weights_file=weights_file,infuse_view=infuse_view,grouped_encoder=grouped_encoder)
mode_sag = HFGAN_3D(view='sag',weights_file=weights_file,infuse_view=infuse_view,grouped_encoder=grouped_encoder)
