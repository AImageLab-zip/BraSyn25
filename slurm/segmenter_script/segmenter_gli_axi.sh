...
#SBATCH -e /home/user/output/slurm/err_segment_only_tw_sag.txt
#SBATCH -o /home/user/output/slurm/out_segment_only_tw_sag.txt
#SBATCH --gres=gpu:1
...
python /home/user/src/training/train_segmenter_crazy.py --identifier segment_met_axi_ \
\
--pretrain-datasets \
...
/work_path/brats2d_sag/train_men_tumoral \
\
...
/work_path/brats2d_cor/train_men_tumoral \
\
...
/work_path/brats2d_axi/train_men_tumoral \
\
\
--batch-size 80 \
--num-classes 4 \
...
\
--val-datasets \
/work_path/brats2d_sag/train_met \
/work_path/brats2d_sag/train_met_add \
\
--train-splits \
...
/work_path/split_files/men_train.csv \
/work_path/split_files/men_val.csv \
\
--val-splits \
