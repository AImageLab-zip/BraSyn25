...
accelerate launch --main_process_port 29999 --num_processes=1 --num_machines=1 --mixed_precision no --dynamo_backend no /home/user/src/training/train_hf_debugged.py \
                    --identifier run_25_2_flash_views --batch-size 16 --epochs 5 --lr 0.00005 --ssim-coefficients 5 --num-workers 8 \
